const setTrendingBtn = () => {
	if (localStorage.getItem('dark-mode') === 'true') {
		...
		$previousBtn.src = 'assets/images/button-slider-left.svg';
		$nextBtn.src = 'assets/images/button-slider-right.svg';
	}
};

$previousBtn.addEventListener('mouseover', () => {
	$previousBtn.src = 'assets/images/button-slider-left-hover.svg';
});

$nextBtn.addEventListener('mouseover', () => {
	$nextBtn.src = 'assets/images/button-slider-right-hover.svg';
});
