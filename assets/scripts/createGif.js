...
const getStreamAndRecord = async () => {
	$crearGifTitle.innerHTML = `¿Nos das acceso <br> a tu camara?`;
	$crearGifText.innerHTML = `El acceso a tu camara sera valido solo <br> por el tiempo en el que estes creando el GIFO.`;
